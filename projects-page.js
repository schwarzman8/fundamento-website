const highlightProjects = [
  {
    ...
    summary: "Familiarization trip kroz Hrvatsku i Crnu Goru, snimljen kao destinacijski sadržaj za Travel Croatia.",
  },
  {
    slug: "splxai",
    title: "SplxAI",
    ...
    summary: "Explainer video i pitch video uz portrete zaposlenika za jačanje profesionalnog dojma brenda.",
  },
  {
    slug: "tomicwinary",
    title: "Tomić Winery",
    client: "Tomić Winery",
    collaboration: "Projektna",
    industry: "Vinarstvo / Ugostiteljstvo",
    format: "Brand film",
    year: "2023",
  ...
  },
  {
    ...
    summary: "Produkcija TV reklame, od kreativne ideje do realizacije.",
  },
  {
    ...
    summary: "Promo film za Trogir Diving Center, jedan od najstarijih ronilačkih centara u Europi, kroz priču o tradiciji, kvaliteti i više od 35 godina iskustva.",
  },
  {
    ...
    summary: "Produkcija Božićne TV reklame od kreativne ideje do realizacije.",
  },
];
...
const partnerProjects = [
  {
    ...
    image: "assets/partners/fortesolar/thumbnail/9-2-1200x1200.jpg",
    preferImage: true,
  ...
  },
  {
    ...
    image: "assets/partners/vwbosnic/Thumbnail/1-11.jpg",
    preferImage: true,
  ...
  },
  {
    ...
    format: "Partnerska suradnja",
    video: "assets/videos/project-02.mp4",
    image: "assets/partners/hotelambasador/Fotografije/2G6A9294.webp",
    preferImage: true,
